...
const Hero = () => {
  return (
    <div className='relative flex md:h-[90vh] w-full flex-col items-center justify-center overflow-hidden px-4 md:flex-row md:gap-16 md:px-12 2xl:gap-24 2xl:px-0'>
      <div className='absolute inset-0 origin-bottom-left transform bg-gradient-to-b from-white to-[rgba(255,173,173,0.2)]'></div>
      <div className='relative z-10 flex h-full w-full flex-col items-center justify-center text-gray-700 md:w-1/2 2xl:w-1/3 mt-6 mb-8'>
        <h1 className='font-blackmango md:text-[3.5em] text-[3em] font-medium leading-[1em] xl:text-[5em]'>
          Your <span className='text-primary-500'>Educator Journey</span> Starts
          Here
        </h1>
        <p className='my-[6%] w-full md:text-[1.5em] text-[1.25em] leading-[1.25em]'>
        ...
        <div className='flex w-full items-center text-[1.1em] font-semibold gap-6 xl:text-[1.3em]'>
          <a href="/about">
            <div className=''>
      ...
      <div className='aboutImageContent relative z-10 w-full md:w-1/2 lg:w-1/3 flex flex-col items-start rounded-2xl rounded-bl-[28px] rounded-tl-[74px] bg-[rgb(255,173,173)]/20 p-3'>
        <img
          className='h-[300px] md:h-[500px] w-[700px] rounded-bl-[64px] rounded-br-[12px] rounded-tl-[64px] rounded-tr-[8px] object-cover object-top'
