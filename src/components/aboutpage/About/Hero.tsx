        ...
        <div className='aboutGridContainer'>
          <div className='aboutFlexBox flex max-w-[90rem] flex-nowrap items-center p-6'>
            ...
            <div className='aboutFlexBoxContainer w-[100%] items-center justify-center'>
              <h1 className='font-blackmango mb-12 flex wax-w-2xl gap-2 break-words text-[4.5em] font-medium leading-[1em] xl:text-[3.5em]'>
                The <span className='mx-2 flex text-[rgb(255,173,173)]'>Microschool</span> Maestro
              </h1>
              ...
              <div className='authorHeroVideoButton mt-12 flex items-center justify-start gap-6'>
                ...
                <a href="https://www.youtube.com/watch?v=OWxvRdrdYbY" target="_blank" rel="noopener noreferrer">
